    ...
    return (
        <div className="w-full bg-white flex flex-col justify-center items-center py-12 md:py-24 lg:py-32">
            <div className="mx-[5%] flex flex-col items-center gap-6 md:gap-8 lg:gap-10">
                ...
                <Link href="/vize" className="text-[10px] md:text-xs font-sans text-[#785A1A] tracking-[0.3em] font-bold uppercase border-b border-[#785A1A]/30 pb-1 hover:border-[#785A1A] transition-all mt-4">
                    NAŠE VIZE A UDRŽITELNOST
                </Link>
            </div>
        </div>
    )
