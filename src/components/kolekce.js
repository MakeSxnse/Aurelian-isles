...
export function Kolekce() {
    return (
        <div id="ostrovy" className="bg-white w-full">
            <div className="mx-[5%] py-16 flex flex-col gap-16">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <Link href="/prodej" className="px-8 py-4 bg-transparent border border-[#785A1A] text-[#785A1A] font-sans text-sm tracking-widest hover:bg-[#785A1A] hover:text-white transition-colors uppercase whitespace-nowrap">
                        ZOBRAZIT KOLEKCI
                    </Link>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-12">
                    ...
                    <div className="md:col-span-2">
                        <Link href="/prodej/1" className="group relative overflow-hidden h-[500px] block">
                            <Image
                            ...
                            <div className="absolute bottom-10 left-10 text-white">
                                <p className="text-[0.7rem] tracking-[0.3em] uppercase mb-2 opacity-80">Maledivy</p>
                                <h3 className="text-3xl font-serif">Aura Bianca</h3>
                            </div>
                        </Link>
                    </div>

                    <div className="md:col-span-1 md:mt-[100px]">
                        <Link href="/prodej/2" className="group relative overflow-hidden h-[500px] block">
                            <Image
